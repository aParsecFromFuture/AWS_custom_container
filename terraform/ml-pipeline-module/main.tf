...
resource "aws_s3_bucket_ownership_controls" "s3_bucket_training_data_acl_ownership" {
  bucket = aws_s3_bucket.bucket_training_data.id
  rule {
...
resource "aws_s3_object" "object" {
  bucket = aws_s3_bucket.bucket_training_data.id
  key    = "loan-training-eligibility.csv"
...
resource "aws_s3_bucket_ownership_controls" "s3_bucket_output_data_acl_ownership" {
  bucket = aws_s3_bucket.bucket_output_models.id
  rule {
    object_ownership = "ObjectWriter"
  }
